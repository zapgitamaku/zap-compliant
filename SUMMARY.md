...
* [BANK Service](bank-service/README.md)
  ...
  * [Add Shmfb Banks](bank-service/add-shmfb-banks.md)
...
* [WALLET Detail Service](wallet-detail-service/README.md)
  * [Add Wallet Details](wallet-detail-service/add-wallet-details.md)
  * [Fetch Wallet Details](wallet-detail-service/fetch-bank-details.md)
  * [Fetch Wallet Details by Id\*](wallet-detail-service/fetch-bank-details-by-id.md)
  * [Fetch Wallet Details by UserId\*](wallet-detail-service/fetch-bank-details-by-userid.md)
  * [Fetch Wallet Details by Address\*](wallet-detail-service/fetch-bank-details-by-userid-1.md)
  * [Edit Wallet Details By Id](wallet-detail-service/edit-bank-details-by-id.md)
  * [Delete Wallet Details By Id](wallet-detail-service/delete-bank-details-by-id.md)
* [CURRENCY Service](currency-service/README.md)
  ...
  * [Fetch Currency Network by ChainId](currency-service/fetch-currency-network-by-chainid.md)
...
* [FAQ Article Service](faq-article-service/README.md)
  ...
  * [Delete Fetch FAQ Article by Id](faq-article-service/delete-fetch-faq-article-by-id.md)
...
* [ORDER Service](order-service/README.md)
  ...
  * [Fill Order by Id](order-service/fill-order-by-id.md)
...
* [VERIFICATION Service](verification-service/README.md)
  ...
  * [Upload Verification(image)](verification-service/upload-verification.md)
  * [Upload Verification(get file url)](verification-service/upload-verification-1.md)
  * [Upload Verification(Url)](verification-service/upload-verification-2.md)
...
* [Support Conversation Service](support-conversation-service/README.md)
  ...
  * [Review Support Conversation](support-conversation-service/add-conversation-rating-2.md)
  * [Mark Support Conversation as spam](support-conversation-service/add-conversation-rating-3.md)
  * [Bulk Support actions(Escalate,Close, MarkAsSpam)](support-conversation-service/add-conversation-rating-4.md)
...
* [PRICE ALERT AND WATCHLIST Service](currency-service-3/README.md)
  * [Fetch Alerts And Watchlist Allowed Tokens](currency-service-3/fetch-currencies.md)
  * [Fetch Specific User Preference](currency-service-3/fetch-currencies-1.md)
  * [Update Token Watchlist](currency-service-3/delete-currency-by-id.md)
  * [Toggle On/Off User Price Alert](currency-service-3/delete-currency-by-id-1.md)
  * [Create Price Alert](currency-service-3/add-currency.md)
  * [Fetch Specific User Alerts](currency-service-3/fetch-currencies-2.md)
  * [Fetch Specific User Token Alerts](currency-service-3/fetch-currencies-3.md)
  * [Update Price Alert](currency-service-3/add-currency-1.md)
  * [Update Price Alert Active Status](currency-service-3/add-currency-2.md)
  * [Delete Specific User Alerts](currency-service-3/fetch-currencies-4.md)
* [SUPPORT COMMAND  Service](currency-service-4/README.md)
  * [Create Support Command](currency-service-4/add-currency.md)
  * [Fetch Support Commands](currency-service-4/fetch-currencies.md)
  * [Fetch Specific Support Command](currency-service-4/delete-currency-by-id.md)
  * [Delete Support Command](currency-service-4/delete-currency-by-id-1.md)
  * [Update Support Command  by id](currency-service-4/edit-support-message-by-id.md)
* [LEADERBOARD Service](currency-service-5/README.md)
  * [Add User To Leaderboard](currency-service-5/delete-currency-by-id.md)
  * [Fetch Users LeaderBoard](currency-service-5/fetch-currencies.md)
  * [Fetch Specific User Rank](currency-service-5/delete-currency-by-id-1.md)
  * [Fetch Specific User Network](currency-service-5/delete-currency-by-id-2.md)
  * [Fetch Leaderboard Avatars](currency-service-5/fetch-currencies-1.md)
  * [Fetch Specific User Streak History](currency-service-5/delete-currency-by-id-3.md)
* [CAREER Service](currency-service-6/README.md)
  * [Create Job Opening](currency-service-6/add-currency.md)
  * [Application to Job Opening](currency-service-6/add-currency-1.md)
  * [Fetch All Jobs](currency-service-6/fetch-currencies.md)
  * [Fetch Specific Job Opening](currency-service-6/delete-currency-by-id.md)
