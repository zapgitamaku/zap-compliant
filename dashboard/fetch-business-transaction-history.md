# Fetch Business Transaction History

### GET /v1/order/history/:businessId <a href="#top" id="top"></a>

Allows the Site Admin to get the business user successful transaction history on the platform.
...
The example below shows a request to fetch a business user transaction history.

#### **Sample request** URL <a href="#top" id="top"></a>

```json
https://{hostname}/v1/order/history/:businessId
```
...
| ----------- | ------ | ----------------------------------------------- |
| Transaction | Object | Contains the business user transaction history. |
