...
### GET /v1/walletDetails <a href="#top" id="top"></a>

Allows a Admin to get all Wallet Details on the platform.
...
<table><thead><tr><th width="225">Key</th><th>Value</th><th>Description</th></tr></thead><tbody><tr><td>bodyLimit</td><td>1</td><td>Optional query parameter that specifies the number of Wallet details in the response body</td></tr><tr><td>pageLimit</td><td>3</td><td>Optional query parameter that paginates the list of wallet details in the response body</td></tr><tr><td>startDate</td><td></td><td>Optional query parameter that adds a start date range to the list of wallet details in the response body</td></tr><tr><td>endDate</td><td></td><td>Optional query parameter that adds a end date range to the list of wallet details in the response body</td></tr></tbody></table>
        ...
        "walletDetailsData": [
            {
                ...
                "userId": {
                    ...
                    "roleId": "6731ef16c625d3773e97a381",
                    "id": "6731ef16c625d3773e97a282"
                },
            ...
            },
            {
                ...
                "userId": {
                    ...
                    "roleId": "6731ef16c625d3773e97a381",
                    "id": "6731ef16c625d3773e97a452"
                },,
                "address": "0x483293A1Dc64A7589C994e633a03e66AE52DD131",
                "name": "Test Wallet",
                "createdAt": "2023-01-22T15:05:59.274Z",
                "updatedAt": "2023-01-22T15:05:59.274Z",
                "id": "63f62f576948a75e61839cb1"
            },
        ],
        "bodyLimit": 2,
        "pageLimit": 1,
...
| ----------------- | ----- | --------------------------------------------------------- |
| WalletDetailsData | Array | Contains information about walletDetails on ZAP platform. |
