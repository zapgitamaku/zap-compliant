...
### GET /v1/walletDetails/users/:userId <a href="#top" id="top"></a>

Allows a User to get Wallet details by userId on the platform.
...
```
https://{hostname}/v1/walletDetails/users/:id
```
...
| --- | ----- | ------------------------------------------- |
| Id  | \<Id> | The unique ID for a specific wallet detail. |
