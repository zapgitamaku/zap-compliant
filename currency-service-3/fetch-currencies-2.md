# Fetch Specific User Alerts

### GET /v1/priceAlertss/:userId <a href="#top" id="top"></a>

Allows a zap user to get all their alerts on the platform.
...
The example below shows a request to get a user alerts.

#### **Sample request** URL <a href="#top" id="top"></a>

```
https://{hostname}/v1/priceAlerts/:userId
```
