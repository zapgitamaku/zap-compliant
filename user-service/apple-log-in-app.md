...
### GET /v1/users/appAuth/apple <a href="#top" id="top"></a>

Allows the Site Admin to log a user in to the app with apple auth.
...
The example below shows a request to log a user in using apple.

#### **Sample request** URL <a href="#top" id="top"></a>

```json
https://{hostname}/v1/users/appAuth/apple
```
...
| ------------------- | ---------------- |
| Content-type        | application/json |
| Apple-Authorization | appleToken       |
