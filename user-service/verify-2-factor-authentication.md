...
### POST /v1/users/:id/verify2FA <a href="#top" id="top"></a>

Allows the zap user to verify 2FA on the platform.
...
```json
https://{hostname}/v1/users/:id/verify2FA
```
...
If successful, this operation returns HTTP status code 200, with a 2FA token verification message.
...
| ---- | ------ | ---------------------------------------------------------------------- |
| 2FA  | Object | Contains information about the ZAP user 2FA token verification status. |
